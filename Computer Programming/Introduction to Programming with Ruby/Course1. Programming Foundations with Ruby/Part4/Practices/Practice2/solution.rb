...
# # TODO: Complete the line below to print the average spending per day
# puts "Average spending per day is"
...
# TODO: Complete the line below to print the average spending per day
puts "Average spending per day is #{trip_cost / days_spent}"