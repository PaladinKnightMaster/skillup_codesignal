...
#     # TODO: Update learning rate based on validation loss

#     # TODO: Print the learning rate every 10 epochs
#     # Hint: Use the optimizer attribute param_groups[0]["lr"]
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 10 == 0:
        ...
        print(f'Epoch [{epoch + 1}/{num_epochs}], LR: {lr:.6f}, Val Loss: {val_loss:.6f}')