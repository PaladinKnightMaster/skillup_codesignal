...
# new_input = torch.tensor([[3.5, 1.5]], dtype=torch.float32)

# # TODO: Set the model to evaluation mode

# # TODO: Disable gradient calculation for inference
#     # TODO: Make a prediction for the new input

# # TODO: Print the raw output from the model

# # TODO: Convert the probability to a binary class label
